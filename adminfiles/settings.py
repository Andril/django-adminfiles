...
JQUERY_URL = getattr(settings, 'JQUERY_URL', 'http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js')
...
ADMINFILES_THUMB_ORDER = getattr(settings, 'ADMINFILES_THUMB_ORDER', ('-upload_date',))
...
ADMINFILES_GALLERY_START = getattr(settings, 'ADMINFILES_GALLERY_START', '<<')

ADMINFILES_GALLERY_END = getattr(settings, 'ADMINFILES_GALLERY_END', '>>')

ADMINFILES_STRING_IF_NOT_FOUND = getattr(settings, 'ADMINFILES_STRING_IF_NOT_FOUND', '')
...
ADMINFILES_BROWSER_VIEWS = getattr(
    settings, 'ADMINFILES_BROWSER_VIEWS', [
